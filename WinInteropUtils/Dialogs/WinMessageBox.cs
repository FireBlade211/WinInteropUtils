...
namespace FireBlade.WinInteropUtils.Dialogs
{
    ...
    /// </summary>
    public class WinMessageBox : DialogWindow<WinMessageBoxResult, WinMessageBox>
    {
        /// <summary>
        ...
        /// </summary>
        public WinMessageBoxButtons Buttons { get; set; } = WinMessageBoxButtons.Ok;

        /// <summary>
        /// Gets or sets the icon displayed on the message box.
        /// </summary>
        public WinMessageBoxIcon Icon { get; set; } = WinMessageBoxIcon.None;
        ...
        /// <summary>
        /// Specifies the modality of the message box. The default is <see cref="WinMessageBoxModality.ApplicationModal"/>.
        /// </summary>
        public WinMessageBoxModality Modality { get; set; } = WinMessageBoxModality.ApplicationModal;
        ...
        /// 
        /// <para>If this flag is set, the <see cref="Show()"/> function should be called instead of <see cref="Show(Window)"/>.
        /// This is so that the message box can appear on a desktop other than the desktop corresponding to the window corresponding
        /// to the specified <c>hWnd</c> in <see cref="Show(Window)"/>.</para>
        /// 
        ...
        private uint MakeMessageBoxFlags()
        {
            ...
            if (Icon != WinMessageBoxIcon.None)
                f |= (uint)Icon;
        ...
        /// 
        /// If a message box has a Cancel button, the function returns the <see cref="WinMessageBoxResult.Cancel"/> value
        ...
        /// </remarks>
        public override WinMessageBoxResult Show() => Show(Window.FromHandleInternal(nint.Zero));

        /// <summary>
        /// Shows the message box.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <returns>
        /// <para>The button that was clicked.</para>
        /// 
        /// If a message box has a Cancel button, the function returns the <see cref="WinMessageBoxResult.Cancel"/> value
        ...
        /// taken from a resource file, because an attempt to load the resource may fail.</para>
        /// </remarks>
        public override WinMessageBoxResult Show(Window wnd)
        {
            ...
            return (WinMessageBoxResult)button;
        }

        /// <summary>
        /// Shows a message box with the specified text and the default caption (Error) as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        ...
        /// <summary>
        /// Shows a message box with the specified text and caption as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <param name="text">The text on the message box.</param>
        ...
        /// </remarks>
        public static WinMessageBoxResult Show(string text) => Show(text, null);
        ...
        /// and show it with the <see cref="Show()"/> method.
        /// </remarks>
        public static WinMessageBoxResult Show(string text, string? caption) => new WinMessageBox
        {
            Text = text,
            Caption = caption
        }.Show();
        ...
        /// </summary>
        /// <param name="text">The text on the message box.</param>
        /// <param name="icon">The icon displayed on the message box. One of the <see cref="WinMessageBoxIcon"/> values.</param>
        /// <param name="buttons">The buttons on the message box. One of the <see cref="WinMessageBoxButtons"/> values.</param>
        /// <returns>
        /// <para>The button that was clicked.</para>
        /// 
        /// If a message box has a Cancel button, the function returns the <see cref="WinMessageBoxResult.Cancel"/> value
        ...
        /// and show it with the <see cref="Show()"/> method.
        /// </remarks>
        public static WinMessageBoxResult Show(string text, WinMessageBoxIcon icon, WinMessageBoxButtons buttons) => Show(text, null, icon, buttons);
        ...
        /// and show it with the <see cref="Show()"/> method.
        /// </remarks>
        public static WinMessageBoxResult Show(string text, string? caption, WinMessageBoxIcon icon, WinMessageBoxButtons buttons) => new WinMessageBox
        {
            Text = text,
            Caption = caption,
            Icon = icon,
        ...
        /// <summary>
        /// Shows a message box with the specified text, icon, and buttons as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <param name="text">The text on the message box.</param>
        /// <param name="icon">The icon displayed on the message box. One of the <see cref="WinMessageBoxIcon"/> values.</param>
        ...
        public static WinMessageBoxResult Show(Window wnd,
            string text,
            WinMessageBoxIcon icon,
            WinMessageBoxButtons buttons) => Show(wnd, text, null, icon, buttons);

        /// <summary>
        /// Shows a message box with the specified text, caption, icon, and buttons as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <param name="text">The text on the message box.</param>
        /// <param name="caption">The caption (title) of the message box.</param>
        ...
        /// and show it with the <see cref="Show()"/> method.
        /// </remarks>
        public static WinMessageBoxResult Show(string text, WinMessageBoxButtons buttons) => Show(text, null, buttons);
        ...
        /// and show it with the <see cref="Show()"/> method.
        /// </remarks>
        public static WinMessageBoxResult Show(string text, string? caption, WinMessageBoxButtons buttons) => new WinMessageBox
        {
            Text = text,
            Caption = caption,
            Buttons = buttons
        ...
        /// <summary>
        /// Shows a message box with the specified text and buttons as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <param name="text">The text on the message box.</param>
        /// <param name="buttons">The buttons on the message box. One of the <see cref="WinMessageBoxButtons"/> values.</param>
        ...
        /// <summary>
        /// Shows a message box with the specified text, caption, and buttons as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <param name="text">The text on the message box.</param>
        /// <param name="caption">The caption (title) of the message box.</param>
        ...
        /// and show it with the <see cref="Show()"/> method.
        /// </remarks>
        public static WinMessageBoxResult Show(string text, WinMessageBoxIcon icon) => Show(text, null, icon);
        ...
        /// and show it with the <see cref="Show()"/> method.
        /// </remarks>
        public static WinMessageBoxResult Show(string text, string? caption, WinMessageBoxIcon icon) => new WinMessageBox
        {
            Text = text,
            Caption = caption,
            Icon = icon
        ...
        /// <summary>
        /// Shows a message box with the specified text and icon as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <param name="text">The text on the message box.</param>
        /// <param name="icon">The icon displayed on the message box. One of the <see cref="WinMessageBoxIcon"/> values.</param>
        ...
        /// <summary>
        /// Shows a message box with the specified text, caption, and icon as a child of the window specified by <paramref name="wnd"/>.
        /// </summary>
        /// <param name="wnd">The parent window to attach the message box to.</param>
        /// <param name="text">The text on the message box.</param>
        /// <param name="caption">The caption (title) of the message box.</param>
    ...
    /// Provides methods for showing a Win32 message box.
    /// </summary>
    [Obsolete("Use WinMessageBox instead. This is only provided as an alias for compatibility and will be removed in the next" +
    " version of WinInteropUtils.")]
    public class Win32MessageBox
    {
        ...
        /// taken from a resource file, because an attempt to load the resource may fail.</para>
        /// </remarks>
        public Win32MessageBoxResult Show() => Show(nint.Zero);
        ...
        /// taken from a resource file, because an attempt to load the resource may fail.</para>
        /// </remarks>
        public Win32MessageBoxResult Show(nint hWnd)
        {
            MSGBOXPARAMSW m_Params = new();
    ...
    /// </summary>
    public enum WinMessageBoxButtons : long
    {
        /// <summary>
    ...
    /// Defines the buttons on a message box.
    /// </summary>
    [Obsolete("Use WinMessageBoxButtons instead. This is only provided as an alias for compatibility and will be removed in the" +
    " next version of WinInteropUtils.")]
    ...
    /// </summary>
    public enum WinMessageBoxResult
    {
        /// <summary>
    ...
    /// Represents the result of the message box.
    /// </summary>
    [Obsolete("Use WinMessageBoxResult instead. This is only provided as an alias for compatibility and will be removed in the" +
        " next version of WinInteropUtils.")]
    ...
    /// </summary>
    public enum WinMessageBoxIcon : long
    {
        /// <summary>
    ...
    /// Specifies the icon in a message box.
    /// </summary>
    [Obsolete("Use WinMessageBoxIcon instead. This is only provided as an alias for compatibility and will be removed in the" +
    " next version of WinInteropUtils.")]
    ...
    /// <summary>
    /// Specifies the modality of a <see cref="WinMessageBox"/>.
    /// </summary>
    public enum WinMessageBoxModality : long
    {
        /// <summary>
    ...
    /// Specifies the modality of a <see cref="WinMessageBox"/>.
    /// </summary>
    [Obsolete("Use WinMessageBoxModality instead. This is only provided as an alias for compatibility and will be removed in the" +
    " next version of WinInteropUtils.")]
