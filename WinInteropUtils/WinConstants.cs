namespace FireBlade.WinInteropUtils
{
    ...
    public static class WinConstants
    {
        ...
        /// <summary>
        /// Defines the <c>MAX_PATH</c> constant, being the maximum length of a file path for applications that don't have
        /// long file path support (unless overriden with the <c>\\?\</c> UNC path prefix).
        /// </summary>
